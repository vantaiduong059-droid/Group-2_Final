...
<div class="d-flex" id="wrapper">
    ...
    <div id="sidebar-wrapper">
        ...
        <div class="list-group list-group-flush mt-3">
            <a href="<?= BASE_URL ?>/student/dashboard" class="list-group-item list-group-item-action active">
                <i class="bi bi-person-badge"></i> Chuyên cần & Tương tác
            </a>
        </div>
        ...
        <div class="sidebar-footer">
            <div class="sidebar-profile">
                <img src="https://ui-avatars.com/api/?name=Student&background=3b82f6&color=fff" alt="User Avatar">
        ...
        <nav class="navbar navbar-expand-lg">
            <div class="container-fluid px-4 py-2">
                ...
                <div class="search-bar d-none d-md-block">
                    <!-- Không cần thanh tìm kiếm cho SV -->
                </div>
